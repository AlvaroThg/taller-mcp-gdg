// CHECKPOINT 4 -- + main() -- servidor funcional completo
// Si te quedaste aquí, tu src/index.ts debería verse exactamente así.
// Este es el servidor base completo: ya puedes probarlo con
// `npx tsx src/index.ts` y conectarlo a Claude Desktop.
